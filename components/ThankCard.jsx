      ...
      <div className="card">
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="font-sans text-[10px] text-gray-700 pt-5">Chatanya</p>
                        </div>
                        <button
                        ...
                        <div
                            className="tp transition-all duration-1000 group-hover:duration-100 bg-indigo-700 absolute group-hover:[clip-path:polygon(50%_0%,_100%_0,_0_0)] w-full h-full [clip-path:polygon(50%_50%,_100%_0,_0_0)]"
                        ></div>
                        <div
                            className="lft transition-all duration-700 absolute w-full h-full bg-indigo-800 [clip-path:polygon(50%_50%,_0_0,_0_100%)]"
                        ></div>
                        <div
                            className="rgt transition-all duration-700 absolute w-full h-full bg-indigo-700 [clip-path:polygon(50%_50%,_100%_0,_100%_100%)]"
                        ></div>
                        <div
                            className="btm transition-all duration-700 absolute w-full h-full bg-indigo-800 [clip-path:polygon(50%_50%,_100%_100%,_0_100%)]"
                        ></div>
                    </div>
                </div>
    </div>
